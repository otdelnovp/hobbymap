...
export { getProfileDisplayRole } from "./_vm/get-profile-display-role";
export { getProfileDisplayHobby } from "./_vm/get-profile-display-hobby";
export { getProfileDisplayHobbyIcon } from "./_vm/get-profile-display-hobby-icon";
